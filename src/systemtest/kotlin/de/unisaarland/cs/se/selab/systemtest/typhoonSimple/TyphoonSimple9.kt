 ...
 */
class TyphoonSimple9 : SystemTestExtension() {
    // short description of the test
    override val description = "Simple Typhoon Test till tick 9"

    // name of the test
    override val name = "Typhoon Test 9"
    ...
    private suspend fun moveShips(tick: Int) {
        when (tick) {
            ...
            8 -> {
                assertNextLine("Ship Movement: Ship 1 moved with speed 20 to tile 22.")
                assertNextLine("Ship Movement: Ship 4 moved with speed 45 to tile 13.")
                assertNextLine("Ship Movement: Ship 5 moved with speed 54 to tile 14.")
            }
            9 -> {
                assertNextLine("Ship Movement: Ship 1 moved with speed 30 to tile 15.")
                assertNextLine("Ship Movement: Ship 4 moved with speed 60 to tile 14.")
            }
        }
    }
