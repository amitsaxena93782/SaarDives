package de.unisaarland.cs.se.selab.systemtest.eventDisrupt
 ...
 */
class EventDisrupt9 : SystemTestExtension() {
    // short description of the test
    override val description = "Simple Refueling Test till tick 9"

    // name of the test
    override val name = "Event Disrupt Test 9"
    ...
    override val scenario = "scenarioFiles/event1.json"
    ...
    private suspend fun moveShips(tick: Int) {
        when (tick) {
            ...
            8 -> {
                assertNextLine("Ship Movement: Ship 0 moved with speed 25 to tile 12.")
                assertNextLine("Ship Movement: Ship 4 moved with speed 15 to tile 13.")
                assertNextLine("Ship Movement: Ship 5 moved with speed 27 to tile 12.")
            }

            9 -> {
                assertNextLine("Ship Movement: Ship 1 moved with speed 10 to tile 33.")
                assertNextLine("Ship Movement: Ship 4 moved with speed 30 to tile 16.")
            }
        }
    }
